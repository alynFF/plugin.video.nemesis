...
dbfile = translate_path('special://profile/addon_data/plugin.video.nemesis/databases/debridcache.db')
...
class DebridCache:
	def get_many(self, hash_list):
		...
		try:
			...
			dbcon = database.connect(dbfile, timeout=40.0, isolation_level=None)
