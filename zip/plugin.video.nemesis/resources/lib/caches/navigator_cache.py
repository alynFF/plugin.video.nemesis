...
dbfile = translate_path('special://profile/addon_data/plugin.video.nemesis/databases/navigator.db')
timeout = 60
...
prop_dict = {'default': 'nemesis_%s_default', 'edited': 'nemesis_%s_edited', 'shortcut_folder': 'nemesis_%s_shortcut_folder'}
...
class NavigatorCache:
	...
	def _connect_database(self):
		self.dbcon = database.connect(dbfile, timeout=timeout, isolation_level=None)
