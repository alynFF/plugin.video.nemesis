...
dbfile = translate_path('special://profile/addon_data/plugin.video.nemesis/databases/traktcache.db')
timeout = 60
...
class TraktCache:
	...
	def connect_database(self):
		return database.connect(dbfile, timeout=timeout, isolation_level=None)
