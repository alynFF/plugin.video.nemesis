...
def get_setting(setting_id, fallback=None):
	try: settings_dict = json.loads(get_property('nemesis_settings'))
...
def make_settings_dict():
	settings_dict = None
	try:
		test_path = translate_path('special://profile/addon_data/plugin.video.nemesis/')
		profile_dir = 'special://profile/addon_data/plugin.video.nemesis/%s'
		...
		set_property('nemesis_settings', json.dumps(settings_dict))
	except: pass
