...
def get_random_episode(tmdb_id, continual=False):
	...
	if continual:
		...
		set_property('nemesis_random_episode_history', json.dumps(episode_history))
...
def play_random_continual(tmdb_id):
	...
	url = get_property('nemesis_background_url')
	clear_property('nemesis_background_url')
