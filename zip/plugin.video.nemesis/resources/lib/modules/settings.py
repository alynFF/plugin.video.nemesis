...
def skin_location():
	return translate_path('special://home/addons/plugin.video.nemesis')
...
def auto_start_nemesis():
	return get_setting('auto_start_nemesis') == 'true'
...
def extras_enabled_lists():
	setting = get_setting('extras.enabled_lists')
...
def nextep_content_settings():
	...
	sort_key = 'nemesis_last_played' if sort_type == 0 else 'nemesis_first_aired' if sort_type == 1 else 'nemesis_name'
