...
fav_database = translate_path('special://profile/addon_data/plugin.video.nemesis/databases/favourites.db')
...
class Favourites:
	...
	def make_database_connection(self):
		self.dbcon = database.connect(fav_database, timeout=40.0, isolation_level=None)
