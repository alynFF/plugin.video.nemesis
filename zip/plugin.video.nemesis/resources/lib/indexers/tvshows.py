...
exit_str, nextpage_str, switchjump_str = ls(32650), ls(32799), ls(32784)
browse_str, jumpto_str, genre_str = ls(32652), ls(32964), ls(32847)
	...
	def build_tvshow_content(self, item_position, _id):
		try:
			...
			if self.is_widget:
				...
				set_property('nemesis_random_params', random_params)
